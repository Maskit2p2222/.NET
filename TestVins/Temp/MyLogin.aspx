<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MyLogin.aspx.cs" Inherits="Temp.Login" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="wrapper fadeInDown">
        <div id="formContent">
            ...
            <asp:TextBox CssClass="fadeIn second" Text="username" ID="UsernameText" runat="server" Width="80%" />
            ...
            <asp:RegularExpressionValidator
                ...
                ForeColor="Red" />
            <asp:TextBox CssClass="fadeIn second" Text="password" ID="PasswordText" runat="server" Width="80%" />
            ...
            <asp:RegularExpressionValidator ID="PwdValidator"
                ...
                ForeColor="Red" />
            <br />
            <asp:Button ID="LoginAction" runat="server" OnClick="LoginAction_Click" align="center" CssClass="fadeIn second" Text="Войти" /><br />
